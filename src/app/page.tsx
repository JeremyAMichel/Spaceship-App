  ...
  return (
    <MotionDiv>
      <Background
        ...
        desktop={desktop.src}
      />
      <main className="relative z-10 min-h-[80vh] flex flex-col justify-evenlyitems-center lg:flex-row lg:items-end lg:justify-between lg:p-32">
        <motion.div
          variants={SLIDE_LEFT}
        ...
        >
          <div
           ...
           duration-[700ms!important] cursor-pointer group-hover:scale-100"
          />
